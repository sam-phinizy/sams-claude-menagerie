...
|--------|-------------|------|
| **joan** | Local code review gate for AI agents via Forgejo. Agents push work to a local Forgejo instance, a human reviews it, and only approved work gets pushed to the real upstream. | [sam-phinizy/joan](https://github.com/sam-phinizy/joan) |
| **remindctl** | Apple Reminders integration via remindctl-mcp. MCP tools for full CRUD on reminders, plus a text-to-reminders skill that parses emails, Slack threads, and meeting notes into structured reminders with smart due dates. | [sam-phinizy/remindctl-mcp](https://github.com/sam-phinizy/remindctl-mcp) |
